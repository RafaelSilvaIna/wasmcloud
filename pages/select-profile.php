            ...
            <form class="modal-form" id="profile-form" novalidate>
                ...
                <div class="input-group username-check-wrapper">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="text" name="username" id="username" placeholder="maria_cine" required autocomplete="off" maxlength="30" pattern="[a-zA-Z0-9_]+">
                    </div>
                ...
                <div class="input-group">
                    ...
                    <div class="account-type-picker">
                        <button type="button" class="account-type-btn active" data-type="standard" id="btn-type-standard" aria-pressed="true">
                        ...
                        <button type="button" class="account-type-btn" data-type="kids" id="btn-type-kids" aria-pressed="false">
                        ...
                        <button type="button" class="account-type-info-btn" id="btn-type-info" aria-label="Saiba mais sobre os tipos de conta">
        ...
        <div class="account-type-cards">
            <div class="account-type-card" data-type="standard">
                ...
                <ul class="atc-features">
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Acesso a todos os filmes e séries</li>
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Conteúdo adulto e infantil</li>
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Todas as categorias disponíveis</li>
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Sem restrições de conteúdo</li>
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Histórico completo de visualização</li>
                </ul>
            ...
            <div class="account-type-card" data-type="kids">
                ...
                <ul class="atc-features">
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Conteúdo exclusivo infantil</li>
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Filmes e séries para crianças</li>
                    <li><i data-lucide="lock" width="15" height="15" class="atc-lock"></i>Conteúdo adulto bloqueado</li>
                    <li><i data-lucide="lock" width="15" height="15" class="atc-lock"></i>Ações limitadas no app</li>
                    <li><i data-lucide="check-circle" width="15" height="15" class="atc-check"></i>Ambiente seguro e monitorado</li>
                </ul>
...
<div class="avatar-modal" id="pipo-avatar-modal" role="dialog" aria-modal="true" aria-labelledby="avatar-modal-title">
    <div class="modal-content modal-content--avatars">
        ...
        <div class="avatar-categories" id="avatar-categories" role="tablist">
            <button class="category-btn active" data-category="adventurer" role="tab" aria-selected="true"><i data-lucide="compass" width="13" height="13"></i>Aventureiro</button>
            <button class="category-btn" data-category="open-peeps" role="tab" aria-selected="false"><i data-lucide="users" width="13" height="13"></i>Pessoas</button>
            <button class="category-btn" data-category="bottts" role="tab" aria-selected="false"><i data-lucide="bot" width="13" height="13"></i>Robôs</button>
            <button class="category-btn" data-category="pixel-art" role="tab" aria-selected="false"><i data-lucide="grid-2x2" width="13" height="13"></i>Pixel</button>
            <button class="category-btn" data-category="notionists" role="tab" aria-selected="false"><i data-lucide="sparkles" width="13" height="13"></i>Notion</button>
        </div>
