...
<head>
    ...
    <style>
        :root { color-scheme: dark; --bg:#080a0f; --panel:#11141b; --panel2:#171b24; --text:#f8fafc; --muted:#9aa4b2; --accent:#e50914; --border:rgba(255,255,255,.08); }
        * { box-sizing:border-box; }
        body { margin:0; min-height:100vh; display:grid; place-items:center; padding:24px; background:radial-gradient(circle at top, rgba(229,9,20,.16), transparent 32%), var(--bg); color:var(--text); font-family:Inter,system-ui,sans-serif; }
        ...
        button, a { min-height:44px; border-radius:12px; font-weight:700; font-size:14px; text-decoration:none; }
